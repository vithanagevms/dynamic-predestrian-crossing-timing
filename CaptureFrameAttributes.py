...
btn_video_select = tk.Button(root, text="Select video file", command=SelectVideo)
...
btn_video_view.grid(row=1, column=0, padx=3, pady=3, columnspan=2, sticky="w")

btn_video_rotate = tk.Button(root, text="Rotate video 90\xb0 clockwise", command=RotateVideoFrame)
btn_video_rotate.grid(row=1, column=2, padx=3, pady=3, columnspan=2)

lbl_sep1 = tk.Label(root, text="-"*80)
lbl_sep1 .grid(row=3, column=0, padx=0, pady=0, columnspan=4)

lbl_1 = tk.Label(root, text="Click on frame in order to mark")
lbl_1.grid(row=4, column=0, padx=0, pady=0, columnspan=4)
lbl_2 = tk.Label(root, text="Left Top, Right Top, Left Down, Right Down")
lbl_2.grid(row=5, column=0, padx=0, pady=0, columnspan=4)
lbl_3 = tk.Label(root, text="points of the pedestrian crossing.")
lbl_3.grid(row=6, column=0, padx=0, pady=0, columnspan=4)
lbl_4 = tk.Label(root, text="Right click to remove last point.")
lbl_4.grid(row=7, column=0, padx=0, pady=0, columnspan=4)

lbl_sep2 = tk.Label(root, text="-"*80)
lbl_sep2.grid(row=8, column=0, padx=0, pady=0, columnspan=4)

lbl_5 = tk.Label(root, text="Enter the distance of the pedestrian crossing in meters")
lbl_5.grid(row=9, column=0, padx=0, pady=0, columnspan=3)

txt_crossing_distance = tk.Text(root, width=5, height=1)
txt_crossing_distance.grid(row=9, column=3, padx=0, pady=0)

lbl_sep3 = tk.Label(root, text="-"*80)
lbl_sep3.grid(row=10, column=0, padx=0, pady=0, columnspan=4)

btn_close = tk.Button(root, text="Read settings and exit", command=ReadSettings)
btn_close.grid(row=11, column=0, padx=0, pady=0, columnspan=4)
...
print("Distance in meters: ", crossing_distance)
crossing_distance_int = 0
if crossing_distance.isdigit():
    crossing_distance_int = int(crossing_distance)
print(crossing_distance_int)


# Write settings to json file
json_string = [{'video_path': video_path, 
